#include "kernel_pinhole_intrinsics_prior_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeIntrinsicsPriorJtjnjtrDirectKernel(
        double* calib_njtr,
...
void PinholeIntrinsicsPriorJtjnjtrDirect(double* calib_njtr,
                                         unsigned int calib_njtr_num_alloc,
                                         SharedIndex* calib_njtr_indices,
                                         double* calib_jac,
                                         unsigned int calib_jac_num_alloc,
  ...
  PinholeIntrinsicsPriorJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      calib_njtr,
