#include "kernel_pinhole_log_depth_fixed_pose_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedPoseScoreKernel(double* scale,
...
void PinholeLogDepthFixedPoseScore(double* scale,
                                   unsigned int scale_num_alloc,
                                   SharedIndex* scale_indices,
                                   double* point,
                                   unsigned int point_num_alloc,
  ...
  PinholeLogDepthFixedPoseScoreKernel<<<n_blocks, 1024>>>(scale,
                                                          scale_num_alloc,
                                                          scale_indices,
                                                          point,
                                                          point_num_alloc,
