#include "kernel_pinhole_fixed_rotation_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedRotationFixedPointScoreKernel(
        double* rotation,
...
void PinholeFixedRotationFixedPointScore(double* rotation,
  ...
  PinholeFixedRotationFixedPointScoreKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
