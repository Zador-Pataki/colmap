...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r23 = r6 * r23;
    r21 = r21 * r23;
    r48 = fma(r19, r21, r23 * r48);
    r49 = r20 * r16;
    r50 = r1 * r27;
    r21 = fma(r0, r21, r23 * r50);
    ...
    r21 = r6 * r38;
    r23 = r4 * r21;
    r48 = fma(r43, r23, r21 * r48);
    r51 = r16 * r46;
    r51 = fma(r21, r51, r45 * r23);
  ...
  FlushSumShared<1, double>(out_translation_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r51 = fma(r43, r43, r33 * r33);
    r48 = fma(r46, r46, r45 * r45);
  ...
  FlushSumShared<1, double>(out_translation_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r48 = fma(r33, r46, r43 * r45);
    r43 = fma(r43, r50, r33 * r49);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r48 = fma(r15, r39, r48);
    WriteIdx2<1024, double, double, double2>(
        out_calib_jac, 2 * out_calib_jac_num_alloc, global_thread_idx, r7, r48);
    r39 = fma(r0, r38, r41);
    r15 = r19 * r20;
    r51 = r0 * r20;
    ...
    WriteIdx2<1024, double, double, double2>(out_calib_jac,
                                             ...
                                             r12);
    r38 = r16 * r40;
    r38 = fma(r45, r23, r21 * r38);
    r44 = r16 * r7;
    r44 = fma(r21, r44, r48 * r23);
    WriteSum2<double, double>((double*)inout_shared, r38, r44);
  };
  ...
  if (global_thread_idx < problem_size) {
    r44 = r16 * r39;
    r44 = fma(r51, r23, r21 * r44);
    r38 = r16 * r41;
    r38 = fma(r21, r38, r12 * r23);
    WriteSum2<double, double>((double*)inout_shared, r44, r38);
  };
  FlushSumShared<2, double>(out_calib_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r38 = fma(r45, r45, r40 * r40);
    r44 = fma(r7, r7, r48 * r48);
    WriteSum2<double, double>((double*)inout_shared, r38, r44);
  };
  ...
  FlushSumShared<2, double>(out_calib_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r38 = fma(r45, r48, r40 * r7);
    r44 = fma(r45, r51, r40 * r39);
    WriteSum2<double, double>((double*)inout_shared, r38, r44);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r45 = fma(r45, r12, r40 * r41);
    r44 = fma(r7, r39, r48 * r51);
  ...
  FlushSumShared<2, double>(out_calib_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r48 = fma(r48, r12, r7 * r41);
    r12 = fma(r39, r41, r51 * r12);
