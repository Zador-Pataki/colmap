#include "kernel_DepthScale_normalize.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    DepthScaleNormalizeKernel(double* precond_diag,
...
void DepthScaleNormalize(double* precond_diag,
                         unsigned int precond_diag_num_alloc,
                         double* precond_tril,
                         unsigned int precond_tril_num_alloc,
                         double* njtr,
  ...
  DepthScaleNormalizeKernel<<<n_blocks, 1024>>>(precond_diag,
