#include "kernel_DepthScale_start_w.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    DepthScaleStartWKernel(double* DepthScale_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = r1 * r0;
    WriteIdx1<1024, double, double, double>(out_DepthScale_w,
...
void DepthScaleStartW(double* DepthScale_precond_diag,
                      unsigned int DepthScale_precond_diag_num_alloc,
                      const double* const diag,
                      double* DepthScale_p,
                      unsigned int DepthScale_p_num_alloc,
  ...
  DepthScaleStartWKernel<<<n_blocks, 1024>>>(DepthScale_precond_diag,
