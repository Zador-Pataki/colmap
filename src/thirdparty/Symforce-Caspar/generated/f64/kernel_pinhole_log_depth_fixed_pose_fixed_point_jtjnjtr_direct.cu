#include "kernel_pinhole_log_depth_fixed_pose_fixed_point_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedPoseFixedPointJtjnjtrDirectKernel(
        double* scale_njtr,
...
void PinholeLogDepthFixedPoseFixedPointJtjnjtrDirect(
  ...
  PinholeLogDepthFixedPoseFixedPointJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      scale_njtr,
