#include "kernel_pinhole_split_fixed_rotation_fixed_focal_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedFocalScoreKernel(
        double* rotation,
...
void PinholeSplitFixedRotationFixedFocalScore(
  ...
  PinholeSplitFixedRotationFixedFocalScoreKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
