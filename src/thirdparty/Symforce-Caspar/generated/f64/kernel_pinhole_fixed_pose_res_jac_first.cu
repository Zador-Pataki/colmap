...
__global__ void __launch_bounds__(1024, 1) PinholeFixedPoseResJacFirstKernel(
  ...
  FlushSumShared<2, double>(out_calib_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r59 = fma(r48, r32, r53 * r51);
    r62 = fma(r48, r56, r53 * r54);
    WriteSum2<double, double>((double*)inout_shared, r59, r62);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r48 = fma(r53, r55, r48 * r58);
    r62 = fma(r51, r54, r32 * r56);
    WriteSum2<double, double>((double*)inout_shared, r48, r62);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r44 = fma(r47, r8, r44);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r9, r44);
    r8 = r21 * r62;
