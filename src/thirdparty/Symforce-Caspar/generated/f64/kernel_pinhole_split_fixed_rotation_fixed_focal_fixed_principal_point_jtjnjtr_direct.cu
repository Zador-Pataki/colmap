#include "kernel_pinhole_split_fixed_rotation_fixed_focal_fixed_principal_point_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedFocalFixedPrincipalPointJtjnjtrDirectKernel(
...
void PinholeSplitFixedRotationFixedFocalFixedPrincipalPointJtjnjtrDirect(
    double* translation_njtr,
    unsigned int translation_njtr_num_alloc,
    SharedIndex* translation_njtr_indices,
    double* translation_jac,
