...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = fma(r1, r27, r0 * r20);
    r48 = fma(r46, r1, r48);
    r33 = r21 * r4;
    r27 = fma(r2, r27, r30 * r20);
    r19 = fma(r1, r19, r27 * r33);
    r10 = r19 * r10;
    r10 = r5 <= r37 ? r19 : r10;
    r47 = r19 * r47;
    r10 = r34 < r38 ? r47 : r10;
