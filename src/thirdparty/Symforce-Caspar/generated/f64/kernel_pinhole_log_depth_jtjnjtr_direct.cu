...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthJtjnjtrDirectKernel(double* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx1<1024, double, double, double>(
        point_jac, 2 * point_jac_num_alloc, global_thread_idx, r5);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r4 = r0 * r6;
    r10 = r1 * r6;
    WriteSum2<double, double>((double*)inout_shared, r4, r10);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, double, double, double2>(
        pose_jac, 2 * pose_jac_num_alloc, global_thread_idx, r4, r11);
    r12 = r4 * r6;
    WriteSum2<double, double>((double*)inout_shared, r12, r10);
  };
  FlushSumShared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    r6 = r11 * r6;
    WriteSum2<double, double>((double*)inout_shared, r10, r6);
  };
  FlushSumShared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r8 = r8 * r0;
    r9 = r9 * r0;
    WriteSum2<double, double>((double*)inout_shared, r8, r9);
  };
...
void PinholeLogDepthJtjnjtrDirect(double* pose_njtr,
                                  unsigned int pose_njtr_num_alloc,
                                  SharedIndex* pose_njtr_indices,
                                  double* pose_jac,
                                  unsigned int pose_jac_num_alloc,
