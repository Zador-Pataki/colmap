...
__global__ void __launch_bounds__(1024, 1) PinholeTranslationRetractKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(PinholeTranslation,
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        r2,
        r3);
    ReadIdx1<1024, double, double, double>(PinholeTranslation,
                                           2 * PinholeTranslation_num_alloc,
                                           global_thread_idx,
                                           r3);
    ...
    WriteIdx1<1024, double, double, double>(
        out_PinholeTranslation_retracted,
        2 * out_PinholeTranslation_retracted_num_alloc,
        global_thread_idx,
        r2);
  };
}
