#include "kernel_pinhole_log_depth_fixed_scale_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedScaleResJacKernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r13 = r26 < r32 ? r16 : r13;
    r13 = r26 < r28 ? r37 : r13;
    r13 = fma(r13, r21, r8 * r20);
    r13 = r28 * r13;
    r13 = r13 * r35;
    r13 = r23 <= r17 ? r0 : r13;
    r13 = fma(r19, r13, r36 * r8);
    r13 = r13 + r31;
    r10 = r10 * r39;
    r10 = r0 < r1 ? r10 : r0;
    r8 = r10 * r34;
  ...
  if (global_thread_idx < problem_size) {
    r31 = r13 * r10;
    r13 = r13 * r39;
    WriteSum2<double, double>((double*)inout_shared, r31, r13);
  };
...
void PinholeLogDepthFixedScaleResJac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* point,
  ...
  PinholeLogDepthFixedScaleResJacKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      point,
