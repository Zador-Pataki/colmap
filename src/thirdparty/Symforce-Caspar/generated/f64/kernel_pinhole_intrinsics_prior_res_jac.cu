...
__global__ void __launch_bounds__(1024, 1) PinholeIntrinsicsPriorResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>(
        (double*)inout_shared, calib_indices_loc[threadIdx.x].target, r7, r8);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        prior, 2 * prior_num_alloc, global_thread_idx, r9, r10);
    r9 = fma(r9, r6, r7);
    r9 = r3 * r9;
    r10 = fma(r10, r6, r8);
    r10 = r2 * r10;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r6 = r2 * r6;
    r6 = r6 * r10;
    WriteSum2<double, double>((double*)inout_shared, r4, r6);
  };
  FlushSumShared<2, double>(out_calib_njtr,
