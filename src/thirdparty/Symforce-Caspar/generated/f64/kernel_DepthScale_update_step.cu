...
__global__ void __launch_bounds__(1024, 1)
    DepthScaleUpdateStepKernel(double* DepthScale_step_k,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx1<1024, double, double, double>(DepthScale_step_k,
...
void DepthScaleUpdateStep(double* DepthScale_step_k,
                          unsigned int DepthScale_step_k_num_alloc,
                          double* DepthScale_p_kp1,
                          unsigned int DepthScale_p_kp1_num_alloc,
                          const double* const alpha,
