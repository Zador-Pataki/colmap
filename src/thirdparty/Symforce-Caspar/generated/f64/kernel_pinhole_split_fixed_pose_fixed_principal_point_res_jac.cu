...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r33 = r4 * r25;
    r55 = r19 * r40;
    r55 = fma(r25, r55, r50 * r33);
    r56 = r19 * r52;
    r56 = fma(r25, r56, r54 * r33);
    WriteSum2<double, double>((double*)inout_shared, r55, r56);
  };
  FlushSumShared<2, double>(out_focal_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r56 = fma(r40, r40, r50 * r50);
    r55 = fma(r54, r54, r52 * r52);
    WriteSum2<double, double>((double*)inout_shared, r56, r55);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r50 = r50 * r21;
    r55 = r3 * r24;
    r55 = fma(r29, r55, r10 * r50);
    r50 = fma(r0, r55, r1 * r54);
    r56 = fma(r47, r50, r49);
    r57 = r15 * r4;
    r55 = fma(r2, r55, r34 * r54);
    r50 = fma(r50, r32, r55 * r57);
    r57 = r50 * r18;
    r57 = r5 <= r38 ? r50 : r57;
    r54 = r50 * r48;
    r57 = r35 < r39 ? r54 : r57;
    ...
    r54 = r54 * r21;
    r58 = r3 * r22;
    r58 = fma(r29, r58, r10 * r54);
    r54 = fma(r0, r58, r1 * r50);
    r59 = fma(r47, r54, r49);
    r60 = r15 * r4;
    r58 = fma(r2, r58, r34 * r50);
    r54 = fma(r54, r32, r58 * r60);
    r60 = r54 * r18;
    r60 = r5 <= r38 ? r54 : r60;
    r50 = r54 * r48;
    r60 = r35 < r39 ? r50 : r60;
    ...
    r9 = fma(r34, r50, r2 * r21);
    r50 = fma(r1, r50, r0 * r21);
    r32 = fma(r50, r32, r9 * r54);
    r18 = r32 * r18;
    r18 = r5 <= r38 ? r32 : r18;
    r48 = r32 * r48;
    r18 = r35 < r39 ? r48 : r18;
    ...
    r9 = fma(r4, r44, r9);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r49, r9);
    r44 = r19 * r56;
    r44 = fma(r55, r33, r25 * r44);
    r51 = r19 * r59;
    r51 = fma(r25, r51, r58 * r33);
  ...
  FlushSumShared<1, double>(out_point_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fma(r55, r55, r56 * r56);
    r51 = fma(r58, r58, r59 * r59);
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r51 = fma(r56, r59, r55 * r58);
    r55 = fma(r55, r9, r56 * r49);
