#include "kernel_PinholeTranslation_update_step.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1) PinholeTranslationUpdateStepKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        PinholeTranslation_step_k,
        0 * PinholeTranslation_step_k_num_alloc,
        global_thread_idx,
        r0,
        r1);
    ReadIdx2<1024, double, double, double2>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        out_PinholeTranslation_step_kp1,
        0 * out_PinholeTranslation_step_kp1_num_alloc,
        global_thread_idx,
        r2,
        r3);
    ReadIdx1<1024, double, double, double>(
        PinholeTranslation_step_k,
        2 * PinholeTranslation_step_k_num_alloc,
        global_thread_idx,
        r3);
    ReadIdx1<1024, double, double, double>(
        PinholeTranslation_p_kp1,
    ...
    WriteIdx1<1024, double, double, double>(
        out_PinholeTranslation_step_kp1,
        2 * out_PinholeTranslation_step_kp1_num_alloc,
        global_thread_idx,
        r4);
  };
}
...
void PinholeTranslationUpdateStep(
  ...
  PinholeTranslationUpdateStepKernel<<<n_blocks, 1024>>>(
      PinholeTranslation_step_k,
      PinholeTranslation_step_k_num_alloc,
      PinholeTranslation_p_kp1,
      PinholeTranslation_p_kp1_num_alloc,
      alpha,
      out_PinholeTranslation_step_kp1,
      out_PinholeTranslation_step_kp1_num_alloc,
      problem_size);
}
