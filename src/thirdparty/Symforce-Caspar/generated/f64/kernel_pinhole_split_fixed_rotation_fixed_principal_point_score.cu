#include "kernel_pinhole_split_fixed_rotation_fixed_principal_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedPrincipalPointScoreKernel(
        double* rotation,
...
void PinholeSplitFixedRotationFixedPrincipalPointScore(
    double* rotation,
    unsigned int rotation_num_alloc,
    double* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeSplitFixedRotationFixedPrincipalPointScoreKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
