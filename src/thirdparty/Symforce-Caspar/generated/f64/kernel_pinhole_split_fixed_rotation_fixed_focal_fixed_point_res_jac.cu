#include "kernel_pinhole_split_fixed_rotation_fixed_focal_fixed_point_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedFocalFixedPointResJacKernel(
        double* rotation,
  ...
  FlushSumShared<1, double>(out_translation_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r13 = fma(r40, r45, r7 * r43);
    r7 = fma(r40, r46, r7 * r42);
    WriteSum2<double, double>((double*)inout_shared, r13, r7);
  };
  ...
  FlushSumShared<2, double>(out_principal_point_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r28 = fma(r42, r42, r7 * r7);
    r3 = fma(r26, r26, r38 * r38);
...
void PinholeSplitFixedRotationFixedFocalFixedPointResJac(
  ...
  PinholeSplitFixedRotationFixedFocalFixedPointResJacKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
