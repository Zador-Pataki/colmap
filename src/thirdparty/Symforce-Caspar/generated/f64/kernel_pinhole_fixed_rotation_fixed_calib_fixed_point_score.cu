#include "kernel_pinhole_fixed_rotation_fixed_calib_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedRotationFixedCalibFixedPointScoreKernel(
        double* rotation,
...
void PinholeFixedRotationFixedCalibFixedPointScore(
  ...
  PinholeFixedRotationFixedCalibFixedPointScoreKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
