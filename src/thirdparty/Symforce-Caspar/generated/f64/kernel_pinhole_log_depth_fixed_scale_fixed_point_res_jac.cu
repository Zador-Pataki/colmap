#include "kernel_pinhole_log_depth_fixed_scale_fixed_point_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedScaleFixedPointResJacKernel(
        double* pose,
...
void PinholeLogDepthFixedScaleFixedPointResJac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* log_depth,
  ...
  PinholeLogDepthFixedScaleFixedPointResJacKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      log_depth,
