...
__global__ void __launch_bounds__(1024, 1)
  ...
  __shared__ double PinholeTranslation_total_ag_local[1];

  __shared__ double PinholeTranslation_total_ac_local[1];
  ...
  SumStore<double>(PinholeTranslation_total_ag_local,
                   (double*)inout_shared,
                   0,
  ...
  SumStore<double>(PinholeTranslation_total_ac_local,
                   (double*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r5);
