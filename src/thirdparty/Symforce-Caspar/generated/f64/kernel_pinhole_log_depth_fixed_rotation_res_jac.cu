#include "kernel_pinhole_log_depth_fixed_rotation_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationResJacKernel(
        double* rotation,
  ...
  if (global_thread_idx < problem_size) {
    ReadShared1<double>(
        (double*)inout_shared, scale_indices_loc[threadIdx.x].target, r14);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
  ...
  if (global_thread_idx < problem_size) {
    ...
    r19 = r20 < r26 ? r3 : r19;
    r19 = r20 < r22 ? r18 : r19;
    r19 = fma(r19, r11, r1 * r32);
    r19 = r22 * r19;
    r19 = r19 * r29;
    r19 = r17 <= r8 ? r0 : r19;
    r1 = fma(r30, r1, r14 * r19);
    r1 = r1 + r25;
    WriteIdx1<1024, double, double, double>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r19 = r20 < r26 ? r18 : r19;
    r19 = r20 < r22 ? r1 : r19;
    r19 = fma(r19, r11, r13 * r32);
    r19 = r22 * r19;
    r19 = r19 * r29;
    r19 = r17 <= r8 ? r0 : r19;
    r19 = fma(r14, r19, r30 * r13);
    r19 = r19 + r25;
    r4 = r4 * r31;
    r4 = r0 < r2 ? r4 : r0;
    r13 = r4 * r28;
    ...
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r19, r4);
    r31 = r7 * r31;
    r31 = r0 < r2 ? r31 : r0;
    r2 = r31 * r28;
    r34 = r31 * r34;
  ...
  if (global_thread_idx < problem_size) {
    r25 = r19 * r4;
    r19 = r19 * r32;
    WriteSum2<double, double>((double*)inout_shared, r25, r19);
  };
...
void PinholeLogDepthFixedRotationResJac(
    double* rotation,
    unsigned int rotation_num_alloc,
    double* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeLogDepthFixedRotationResJacKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
