#include "kernel_pinhole_split_fixed_rotation_fixed_focal_fixed_principal_point_res_jac_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedFocalFixedPrincipalPointResJacFirstKernel(
        double* rotation,
  ...
  FlushSumShared<1, double>(out_translation_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r56 = fma(r49, r53, r47 * r51);
    r47 = fma(r49, r54, r47 * r48);
    WriteSum2<double, double>((double*)inout_shared, r56, r47);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r47 = r31 * r6;
    r47 = r47 * r20;
    r47 = fma(r8, r47, r29 * r51);
    r51 = fma(r0, r47, r1 * r24);
    r47 = fma(r30, r47, r2 * r24);
    r48 = fma(r47, r19, r51 * r48);
    r24 = r48 * r14;
    r24 = r5 <= r37 ? r48 : r24;
    r56 = r48 * r39;
    r24 = r34 < r38 ? r56 : r24;
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r57 = fma(r48, r59, r56 * r47);
    r56 = fma(r56, r10, r48 * r33);
...
void PinholeSplitFixedRotationFixedFocalFixedPrincipalPointResJacFirst(
    double* rotation,
    unsigned int rotation_num_alloc,
    double* translation,
    unsigned int translation_num_alloc,
