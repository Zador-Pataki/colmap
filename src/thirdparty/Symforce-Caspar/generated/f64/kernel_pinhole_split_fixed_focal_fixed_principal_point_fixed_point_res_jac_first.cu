...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r24 = fma(r4, r24, r65);
    r24 = fma(r56, r31, r24);
    r60 = fma(r24, r29, r64 * r60);
    r31 = r13 * r4;
    r2 = r42 * r6;
    r2 = r2 * r27;
    r43 = fma(r43, r7, r3 * r2);
    r2 = r0 * r6;
    r2 = r2 * r27;
    r7 = fma(r1, r7, r3 * r2);
    r12 = fma(r7, r12, r43 * r31);
    r23 = r12 * r23;
    r23 = r5 <= r47 ? r12 : r23;
    r41 = r12 * r41;
    r23 = r44 < r48 ? r41 : r23;
    ...
    WriteSum2<double, double>((double*)inout_shared, r60, r29);
  };
  FlushSumShared<2, double>(out_pose_njtr,
  ...
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r63 = fma(r63, r44, r49 * r57);
    r60 = fma(r26, r34, r66 * r16);
    WriteSum2<double, double>((double*)inout_shared, r63, r60);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r60 = fma(r66, r8, r26 * r22);
    r63 = fma(r26, r24, r66 * r9);
    WriteSum2<double, double>((double*)inout_shared, r60, r63);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
