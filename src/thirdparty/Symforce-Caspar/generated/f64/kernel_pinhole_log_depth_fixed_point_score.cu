#include "kernel_pinhole_log_depth_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedPointScoreKernel(double* pose,
...
void PinholeLogDepthFixedPointScore(double* pose,
                                    unsigned int pose_num_alloc,
                                    SharedIndex* pose_indices,
                                    double* scale,
                                    unsigned int scale_num_alloc,
  ...
  PinholeLogDepthFixedPointScoreKernel<<<n_blocks, 1024>>>(pose,
                                                           pose_num_alloc,
                                                           pose_indices,
                                                           scale,
                                                           scale_num_alloc,
