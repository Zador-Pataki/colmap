...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r35, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r35, r39);
  };
  FlushSumShared<2, double>(out_calib_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = fma(r20, r20, r43 * r43);
    WriteSum2<double, double>((double*)inout_shared, r39, r35);
  };
  FlushSumShared<2, double>(out_calib_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r35 = fma(r0, r0, r36 * r36);
    r39 = fma(r10, r10, r8 * r8);
    WriteSum2<double, double>((double*)inout_shared, r35, r39);
  };
  FlushSumShared<2, double>(out_calib_precond_diag,
  ...
  FlushSumShared<2, double>(out_calib_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r37 = fma(r41, r8, r37 * r10);
    r35 = fma(r20, r0, r43 * r36);
  ...
  FlushSumShared<2, double>(out_calib_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r43 = fma(r20, r8, r43 * r10);
    r10 = fma(r0, r8, r36 * r10);
