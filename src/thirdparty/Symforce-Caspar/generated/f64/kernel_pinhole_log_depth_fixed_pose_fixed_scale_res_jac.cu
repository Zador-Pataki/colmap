#include "kernel_pinhole_log_depth_fixed_pose_fixed_scale_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedPoseFixedScaleResJacKernel(
        double* point,
...
void PinholeLogDepthFixedPoseFixedScaleResJac(
    double* point,
    unsigned int point_num_alloc,
    SharedIndex* point_indices,
    double* log_depth,
  ...
  PinholeLogDepthFixedPoseFixedScaleResJacKernel<<<n_blocks, 1024>>>(
      point,
      point_num_alloc,
      point_indices,
      log_depth,
