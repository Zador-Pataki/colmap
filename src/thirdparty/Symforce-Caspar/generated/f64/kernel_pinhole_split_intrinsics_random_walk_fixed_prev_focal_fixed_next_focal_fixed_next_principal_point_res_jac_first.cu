#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_fixed_next_focal_fixed_next_principal_point_res_jac_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedNextFocalFixedNextPrincipalPointResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r12 = r8 * r6;
    WriteIdx2<1024, double, double, double2>(
        out_res, 2 * out_res_num_alloc, global_thread_idx, r9, r12);
    r7 = r7 * r7;
    r12 = r11 * r7;
    r8 = r8 * r8;
    r9 = r6 * r8;
    r6 = fma(r6, r9, r11 * r12);
    r11 = r0 * r4;
    r6 = fma(r2, r11, r6);
    r2 = r1 * r5;
    r6 = fma(r3, r2, r6);
