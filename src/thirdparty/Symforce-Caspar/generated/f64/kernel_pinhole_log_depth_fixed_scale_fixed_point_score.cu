#include "kernel_pinhole_log_depth_fixed_scale_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedScaleFixedPointScoreKernel(
        double* pose,
...
void PinholeLogDepthFixedScaleFixedPointScore(double* pose,
                                              unsigned int pose_num_alloc,
                                              SharedIndex* pose_indices,
                                              double* log_depth,
                                              unsigned int log_depth_num_alloc,
  ...
  PinholeLogDepthFixedScaleFixedPointScoreKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      log_depth,
