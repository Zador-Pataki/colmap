#include "kernel_PinholeTranslation_update_step_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeTranslationUpdateStepFirstKernel(
...
void PinholeTranslationUpdateStepFirst(
    double* PinholeTranslation_p_kp1,
    unsigned int PinholeTranslation_p_kp1_num_alloc,
    const double* const alpha,
    double* out_PinholeTranslation_step_kp1,
  ...
  PinholeTranslationUpdateStepFirstKernel<<<n_blocks, 1024>>>(
      PinholeTranslation_p_kp1,
