...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, double, double, double2>(
        focal_jac, 2 * focal_jac_num_alloc, global_thread_idx, r6, r7);
    r8 = fma(r3, r7, r2 * r5);
    r2 = fma(r2, r4, r3 * r6);
    r3 = fma(r0, r2, r1 * r8);
    ReadIdx2<1024, double, double, double2>(translation_jac,
                                            ...
                                            r9,
                                            r10);
    r11 = fma(r9, r2, r10 * r8);
    WriteSum2<double, double>((double*)inout_shared, r3, r11);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r4 = fma(r4, r9, r5 * r10);
    r9 = fma(r6, r9, r7 * r10);
    WriteSum2<double, double>((double*)inout_shared, r4, r9);
  };
