...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r5 = r5 * r37;
    r38 = fma(r17, r5, r38);
    r39 = fma(r38, r41, r40 * r39);
    r5 = r27 * r19;
    r5 = r5 * r4;
    r17 = r19 * r22;
    r43 = r1 * r16;
    r17 = fma(r43, r17, r16 * r5);
    r5 = r17 * r14;
    r5 = r8 <= r21 ? r17 : r5;
    r44 = r17 * r29;
    r5 = r3 < r31 ? r44 : r5;
  ...
  FlushSumShared<1, double>(out_translation_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r3 = fma(r9, r9, r38 * r38);
    r41 = fma(r44, r44, r17 * r17);
    WriteSum2<double, double>((double*)inout_shared, r3, r41);
  };
  ...
  FlushSumShared<1, double>(out_translation_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r41 = fma(r9, r44, r38 * r17);
    r38 = fma(r9, r39, r38 * r42);
    WriteSum2<double, double>((double*)inout_shared, r41, r38);
  };
