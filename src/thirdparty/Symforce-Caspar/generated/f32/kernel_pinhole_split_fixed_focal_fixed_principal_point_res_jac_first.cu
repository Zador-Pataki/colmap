...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r17 = fmaf(r17, r48, r25 * r44);
    r48 = fmaf(r14, r48, r11 * r44);
    WriteSum3<float, float>((float*)inout_shared, r41, r17, r48);
  };
