#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_fixed_prev_principal_point_fixed_next_principal_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextPrincipalPointScoreKernel(
        float* next_focal,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, float, float, float2>(
        prev_focal, 0 * prev_focal_num_alloc, global_thread_idx, r2, r1);
    r2 = fmaf(r2, r4, r3);
    r2 = r2 * r2;
    r0 = r0 * r0;
    r4 = fmaf(r1, r4, r6);
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextPrincipalPointScore(
    float* next_focal,
    unsigned int next_focal_num_alloc,
    SharedIndex* next_focal_indices,
    float* inv_std,
