#include "kernel_pinhole_split_intrinsics_random_walk_fixed_next_focal_fixed_next_principal_point_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedNextFocalFixedNextPrincipalPointJtjnjtrDirectKernel(
...
void PinholeSplitIntrinsicsRandomWalkFixedNextFocalFixedNextPrincipalPointJtjnjtrDirect(
    float* prev_focal_njtr,
    unsigned int prev_focal_njtr_num_alloc,
    SharedIndex* prev_focal_njtr_indices,
    float* prev_focal_jac,
