#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_principal_point_fixed_next_principal_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevPrincipalPointFixedNextPrincipalPointScoreKernel(
        float* prev_focal,
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevPrincipalPointFixedNextPrincipalPointScore(
    float* prev_focal,
    unsigned int prev_focal_num_alloc,
    SharedIndex* prev_focal_indices,
    float* next_focal,
