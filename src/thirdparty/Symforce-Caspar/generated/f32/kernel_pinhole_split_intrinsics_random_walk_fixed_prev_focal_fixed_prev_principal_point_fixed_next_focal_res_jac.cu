#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_fixed_prev_principal_point_fixed_next_focal_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextFocalResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        out_res, 0 * out_res_num_alloc, global_thread_idx, r6, r7, r0, r4);
    r7 = r2 * r8;
    r7 = r7 * r0;
    r8 = r3 * r8;
    r8 = r8 * r4;
    WriteSum2<float, float>((float*)inout_shared, r7, r8);
  };
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextFocalResJac(
    float* next_principal_point,
    unsigned int next_principal_point_num_alloc,
    SharedIndex* next_principal_point_indices,
    float* inv_std,
