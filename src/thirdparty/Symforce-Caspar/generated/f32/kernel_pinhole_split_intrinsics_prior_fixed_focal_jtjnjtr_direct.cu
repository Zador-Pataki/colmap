#include "kernel_pinhole_split_intrinsics_prior_fixed_focal_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsPriorFixedFocalJtjnjtrDirectKernel(
...
void PinholeSplitIntrinsicsPriorFixedFocalJtjnjtrDirect(
    float* principal_point_njtr,
    unsigned int principal_point_njtr_num_alloc,
    SharedIndex* principal_point_njtr_indices,
    float* principal_point_jac,
  ...
  PinholeSplitIntrinsicsPriorFixedFocalJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
