...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r50 = r50 * r46;
    r50 = r6 <= r31 ? r20 : r50;
    r54 = fmaf(r15, r50, r48);
    r54 = fmaf(r47, r36, r54);
    r36 = r8 * r7;
    r36 = r36 * r49;
    r50 = fmaf(r7, r50, r36);
    r49 = r2 * r47;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r34 = r34 * r46;
    r34 = r6 <= r31 ? r20 : r34;
    r48 = fmaf(r15, r34, r48);
    r48 = fmaf(r47, r22, r48);
    r34 = fmaf(r7, r34, r36);
    ...
    r36 = r15 * r60;
    r36 = fmaf(r55, r11, r52 * r36);
    r22 = r15 * r48;
    r11 = fmaf(r34, r11, r52 * r22);
    WriteSum3<float, float>((float*)inout_shared, r10, r36, r11);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r36 = fmaf(r55, r55, r60 * r60);
    r10 = fmaf(r48, r48, r34 * r34);
    WriteSum3<float, float>((float*)inout_shared, r11, r36, r10);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r57 = fmaf(r40, r48, r57 * r34);
    r34 = fmaf(r60, r48, r55 * r34);
