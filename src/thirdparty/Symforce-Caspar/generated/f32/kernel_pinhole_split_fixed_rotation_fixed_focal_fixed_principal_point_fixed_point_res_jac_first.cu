#include "kernel_pinhole_split_fixed_rotation_fixed_focal_fixed_principal_point_fixed_point_res_jac_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedFocalFixedPrincipalPointFixedPointResJacFirstKernel(
        float* rotation,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, float, float, float2>(
        out_res, 0 * out_res_num_alloc, global_thread_idx, r10, r38);
    r38 = r37 * r37;
    r10 = r7 * r7;
    r10 = r10 * r37;
    r10 = fmaf(r37, r10, r12 * r38);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r34 = r34 * r39;
    r34 = r34 * r14;
    r12 = fmaf(r12, r34, r35 * r42);
    r12 = r9 * r12;
    r36 = rsqrtf(r36);
    r12 = r12 * r36;
    r12 = r6 <= r29 ? r27 : r12;
    r42 = r8 * r15;
    r14 = 2.50000000000000000e-01;
    r39 = r6 <= r30 ? r27 : r27;
    r39 = r11 < r31 ? r27 : r39;
    r39 = r11 < r33 ? r27 : r39;
    r39 = r11 < r9 ? r27 : r39;
    ...
    r39 = r6 <= r29 ? r27 : r39;
    r42 = r42 * r39;
    r14 = fmaf(r15, r12, r42);
    r13 = r0 * r37;
    r14 = fmaf(r25, r13, r14);
    r13 = r15 * r14;
    r25 = r8 * r37;
    r5 = r7 * r25;
    r20 = r8 * r7;
    ...
    r10 = r11 < r9 ? r45 : r10;
    r11 = r9 * r10;
    r11 = fmaf(r35, r11, r45 * r34);
    r11 = r9 * r11;
    r11 = r11 * r36;
    r11 = r6 <= r29 ? r27 : r11;
    r20 = fmaf(r7, r11, r20);
    r20 = fmaf(r37, r46, r20);
    r22 = fmaf(r37, r22, r42);
    r22 = fmaf(r15, r11, r22);
    r11 = r15 * r22;
    r11 = fmaf(r25, r11, r20 * r5);
  ...
  FlushSumShared<3, float>(out_translation_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r13 = fmaf(r14, r39, r12 * r43);
    r12 = fmaf(r12, r20, r14 * r22);
    r20 = fmaf(r39, r22, r43 * r20);
    WriteSum3<float, float>((float*)inout_shared, r13, r12, r20);
  };
...
void PinholeSplitFixedRotationFixedFocalFixedPrincipalPointFixedPointResJacFirst(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
