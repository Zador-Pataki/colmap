#include "kernel_pinhole_fixed_rotation_fixed_calib_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedRotationFixedCalibResJacKernel(
        float* rotation,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r7 = r13 * r59;
    r7 = fmaf(r49, r57, r11 * r7);
    r4 = r13 * r47;
    r57 = fmaf(r15, r57, r11 * r4);
    WriteSum3<float, float>((float*)inout_shared, r35, r7, r57);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r7 = fmaf(r49, r49, r59 * r59);
    r35 = fmaf(r15, r15, r47 * r47);
    WriteSum3<float, float>((float*)inout_shared, r57, r7, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r51 = fmaf(r51, r15, r56 * r47);
    r15 = fmaf(r49, r15, r59 * r47);
...
void PinholeFixedRotationFixedCalibResJac(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeFixedRotationFixedCalibResJacKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
