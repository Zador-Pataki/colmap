...
__global__ void __launch_bounds__(1024, 1) PinholeFixedPoseResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r28 = r8 <= r31 ? r20 : r28;
    r49 = r49 * r28;
    r42 = fmaf(r15, r51, r49);
    r42 = fmaf(r47, r11, r42);
    r11 = r10 * r9;
    r11 = r11 * r28;
    r51 = fmaf(r9, r51, r11);
    r28 = r2 * r47;
    r51 = fmaf(r35, r28, r51);
    r28 = r13 * r12;
    r35 = r1 * r21;
    r35 = r35 * r15;
    r52 = r3 * r21;
    ...
    r28 = r34 < r37 ? r52 : r28;
    r53 = r37 * r28;
    r52 = fmaf(r52, r44, r45 * r53);
    r52 = r37 * r52;
    r52 = r52 * r46;
    r52 = r8 <= r31 ? r20 : r52;
    r53 = fmaf(r15, r52, r49);
    r54 = r1 * r13;
    r54 = r54 * r47;
    ...
    r56 = r34 < r37 ? r55 : r56;
    r57 = r37 * r56;
    r57 = fmaf(r45, r57, r55 * r44);
    r57 = r37 * r57;
    r57 = r57 * r46;
    r57 = r8 <= r31 ? r20 : r57;
    r54 = fmaf(r15, r57, r54);
    r55 = fmaf(r2, r47, r11);
    r55 = fmaf(r9, r57, r55);
    r57 = r3 * r21;
    r57 = fmaf(r9, r57, r35);
    ...
    r35 = r34 < r37 ? r57 : r35;
    r58 = r37 * r35;
    r57 = fmaf(r57, r44, r45 * r58);
    r57 = r37 * r57;
    r57 = r57 * r46;
    r57 = r8 <= r31 ? r20 : r57;
    r58 = fmaf(r15, r57, r49);
    r58 = fmaf(r1, r47, r58);
    r57 = fmaf(r9, r57, r11);
    r57 = fmaf(r3, r47, r57);
    WriteIdx4<1024, float, float, float4>(out_calib_jac,
    ...
    r62 = r15 * r53;
    r62 = fmaf(r52, r60, r59 * r62);
    r63 = r15 * r54;
    r63 = fmaf(r59, r63, r55 * r60);
    r64 = r15 * r58;
    r64 = fmaf(r59, r64, r57 * r60);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r63 = fmaf(r52, r52, r53 * r53);
    r62 = fmaf(r55, r55, r54 * r54);
    r61 = fmaf(r58, r58, r57 * r57);
  ...
  FlushSumShared<4, float>(out_calib_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r61 = fmaf(r42, r53, r51 * r52);
    r62 = fmaf(r42, r54, r51 * r55);
    r51 = fmaf(r42, r58, r51 * r57);
    r63 = fmaf(r52, r55, r53 * r54);
  ...
  FlushSumShared<4, float>(out_calib_precond_tril,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r52 = fmaf(r53, r58, r52 * r57);
    r57 = fmaf(r54, r58, r55 * r57);
    WriteSum2<float, float>((float*)inout_shared, r52, r57);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r6 = r6 * r10;
    r6 = r6 * r22;
    r52 = fmaf(r25, r6, r12 * r52);
    r55 = r5 * r7;
    r63 = r25 * r10;
    r63 = r63 * r22;
    r63 = fmaf(r14, r63, r12 * r55);
    r55 = fmaf(r3, r63, r2 * r52);
    r63 = fmaf(r1, r63, r0 * r52);
    r57 = fmaf(r63, r48, r55 * r57);
    r52 = r57 * r50;
    r52 = r8 <= r38 ? r57 : r52;
    r51 = r57 * r36;
    r52 = r34 < r39 ? r51 : r52;
    ...
    r52 = r34 < r37 ? r57 : r52;
    r51 = r37 * r52;
    r51 = fmaf(r45, r51, r57 * r44);
    r51 = r37 * r51;
    r51 = r51 * r46;
    r51 = r8 <= r31 ? r20 : r51;
    r57 = fmaf(r15, r51, r49);
    r57 = fmaf(r47, r63, r57);
    r51 = fmaf(r9, r51, r11);
    ...
    r55 = r55 * r46;
    r55 = r8 <= r31 ? r20 : r55;
    r64 = fmaf(r15, r55, r49);
    r64 = fmaf(r47, r61, r64);
    r62 = fmaf(r47, r62, r11);
    r62 = fmaf(r9, r55, r62);
    ...
    r50 = r34 < r37 ? r48 : r50;
    r34 = r37 * r50;
    r44 = fmaf(r48, r44, r45 * r34);
    r44 = r37 * r44;
    r44 = r44 * r46;
    r44 = r8 <= r31 ? r20 : r44;
    r49 = fmaf(r15, r44, r49);
    r49 = fmaf(r47, r65, r49);
    r61 = fmaf(r47, r61, r11);
    r61 = fmaf(r9, r44, r61);
    ...
    r11 = r15 * r64;
    r11 = fmaf(r62, r60, r59 * r11);
    r65 = r15 * r49;
    r60 = fmaf(r61, r60, r59 * r65);
    WriteSum3<float, float>((float*)inout_shared, r44, r11, r60);
  };
  FlushSumShared<3, float>(out_point_njtr,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r60 = fmaf(r51, r51, r57 * r57);
    r11 = fmaf(r62, r62, r64 * r64);
    r44 = fmaf(r49, r49, r61 * r61);
    WriteSum3<float, float>((float*)inout_shared, r60, r11, r44);
  };
  FlushSumShared<3, float>(out_point_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r44 = fmaf(r57, r64, r51 * r62);
    r51 = fmaf(r51, r61, r57 * r49);
    r61 = fmaf(r64, r49, r62 * r61);
