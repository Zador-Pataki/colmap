#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalScoreKernel(
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevFocalScore(
    float* prev_principal_point,
    unsigned int prev_principal_point_num_alloc,
    SharedIndex* prev_principal_point_indices,
    float* next_focal,
  ...
  PinholeSplitIntrinsicsRandomWalkFixedPrevFocalScoreKernel<<<n_blocks, 1024>>>(
