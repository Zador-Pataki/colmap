#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_fixed_prev_principal_point_fixed_next_focal_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextFocalJtjnjtrDirectKernel(
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextFocalJtjnjtrDirect(
    float* next_principal_point_njtr,
    unsigned int next_principal_point_njtr_num_alloc,
    SharedIndex* next_principal_point_njtr_indices,
    float* next_principal_point_jac,
  ...
  PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointFixedNextFocalJtjnjtrDirectKernel<<<
      n_blocks,
      1024>>>(next_principal_point_njtr,
