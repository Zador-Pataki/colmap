#include "kernel_pinhole_log_depth_fixed_rotation_fixed_scale_fixed_point_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationFixedScaleFixedPointResJacKernel(
        float* rotation,
...
void PinholeLogDepthFixedRotationFixedScaleFixedPointResJac(
  ...
  PinholeLogDepthFixedRotationFixedScaleFixedPointResJacKernel<<<n_blocks,
                                                                 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
