#include "kernel_pinhole_split_intrinsics_random_walk_fixed_next_principal_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedNextPrincipalPointScoreKernel(
        float* prev_focal,
...
void PinholeSplitIntrinsicsRandomWalkFixedNextPrincipalPointScore(
    float* prev_focal,
    unsigned int prev_focal_num_alloc,
    SharedIndex* prev_focal_indices,
    float* prev_principal_point,
  ...
  PinholeSplitIntrinsicsRandomWalkFixedNextPrincipalPointScoreKernel<<<n_blocks,
                                                                       1024>>>(
      prev_focal,
