#include "kernel_pinhole_log_depth_res_jac_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1) PinholeLogDepthResJacFirstKernel(
    float* pose,
  ...
  if (global_thread_idx < problem_size) {
    ReadShared1<float>(
        (float*)inout_shared, scale_indices_loc[threadIdx.x].target, r17);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = r2 * r35;
    r2 = r25 <= r17 ? r0 : r2;
    r4 = fmaf(r36, r4, r19 * r2);
    r4 = r4 + r26;
    WriteIdx1<1024, float, float, float>(
        out_scale_jac, 0 * out_scale_jac_num_alloc, global_thread_idx, r4);
    r2 = r18 * r19;
    r2 = r2 * r36;
    r2 = r2 * r4;
  ...
  if (global_thread_idx < problem_size) {
    r4 = r4 * r4;
    WriteSum1<float, float>((float*)inout_shared, r4);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = r21 < r32 ? r37 : r2;
    r2 = r21 < r28 ? r4 : r2;
    r2 = fmaf(r2, r23, r9 * r27);
    r2 = r28 * r2;
    r2 = r2 * r35;
    r2 = r25 <= r17 ? r0 : r2;
    r2 = fmaf(r19, r2, r36 * r9);
    r2 = r2 + r26;
    r11 = r11 * r39;
    r11 = r0 < r3 ? r11 : r0;
    r9 = r11 * r20;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = r2 * r39;
    r39 = r4 * r39;
    WriteSum3<float, float>((float*)inout_shared, r26, r2, r39);
  };
...
void PinholeLogDepthResJacFirst(float* pose,
                                unsigned int pose_num_alloc,
                                SharedIndex* pose_indices,
                                float* scale,
                                unsigned int scale_num_alloc,
  ...
  PinholeLogDepthResJacFirstKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      scale,
