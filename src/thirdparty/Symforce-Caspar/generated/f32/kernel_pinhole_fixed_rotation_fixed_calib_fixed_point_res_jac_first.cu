...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = fmaxf(r30, r14);
    r31 = sqrtf(r16);
    r7 = fmaf(r10, r6, r31 * r7);
    r7 = r14 <= r6 ? r14 : r7;
    r31 = 2.50000000000000000e+00;
    r32 = 1.0 / r6;
    r32 = fmaf(r14, r32, r22);
    r33 = logf(r32);
    r33 = r33 * r6;
    r7 = r13 < r31 ? r33 : r7;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r34 = r34 * r40;
    r34 = r34 * r16;
    r39 = fmaf(r39, r34, r35 * r42);
    r39 = r11 * r39;
    r39 = r39 * r36;
    r39 = r14 <= r30 ? r29 : r39;
    r42 = fmaf(r17, r39, r12);
    r42 = fmaf(r37, r38, r42);
    r38 = r17 * r42;
    r16 = r10 * r37;
    r40 = r9 * r16;
    r15 = r10 * r9;
    ...
    r43 = fmaf(r17, r43, r12);
    r44 = r1 * r5;
    r44 = r44 * r37;
    r43 = fmaf(r23, r44, r43);
    r44 = r17 * r43;
    r44 = fmaf(r16, r44, r27 * r40);
    r23 = r25 * r17;
    r45 = r1 * r10;
    r26 = r26 * r26;
    r26 = 1.0 / r26;
    ...
    r0 = fmaf(r17, r13, r0);
    r13 = r17 * r0;
    r13 = fmaf(r16, r13, r15 * r40);
    WriteSum3<float, float>((float*)inout_shared, r38, r44, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r38 = fmaf(r15, r15, r0 * r0);
    WriteSum3<float, float>((float*)inout_shared, r13, r44, r38);
  };
  FlushSumShared<3, float>(out_translation_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r38 = fmaf(r42, r43, r39 * r27);
    r39 = fmaf(r42, r0, r39 * r15);
    r15 = fmaf(r43, r0, r27 * r15);
    WriteSum3<float, float>((float*)inout_shared, r38, r39, r15);
  };
