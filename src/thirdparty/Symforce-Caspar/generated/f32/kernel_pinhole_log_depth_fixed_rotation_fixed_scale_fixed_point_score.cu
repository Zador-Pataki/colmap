#include "kernel_pinhole_log_depth_fixed_rotation_fixed_scale_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationFixedScaleFixedPointScoreKernel(
        float* rotation,
...
void PinholeLogDepthFixedRotationFixedScaleFixedPointScore(
  ...
  PinholeLogDepthFixedRotationFixedScaleFixedPointScoreKernel<<<n_blocks,
                                                                1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
