#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_fixed_next_principal_point_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedNextPrincipalPointJtjnjtrDirectKernel(
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedNextPrincipalPointJtjnjtrDirect(
    float* prev_principal_point_njtr,
    unsigned int prev_principal_point_njtr_num_alloc,
    SharedIndex* prev_principal_point_njtr_indices,
    float* prev_principal_point_jac,
