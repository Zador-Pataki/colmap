#include "kernel_pinhole_log_depth_fixed_rotation_fixed_scale_fixed_point_res_jac_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationFixedScaleFixedPointResJacFirstKernel(
        float* rotation,
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx1<1024, float, float, float>(
        scale, 0 * scale_num_alloc, global_thread_idx, r2);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r18 * r17;
    r18 = r18 * r25;
    r32 = fmaf(r11, r18, r32 * r14);
    r32 = r19 * r32;
    r26 = rsqrtf(r26);
    r32 = r32 * r26;
    r32 = r16 <= r6 ? r0 : r32;
    r1 = fmaf(r32, r1, r27 * r29);
    r32 = r4 * r27;
    r1 = fmaf(r11, r32, r1);
    r11 = r3 * r2;
    r11 = r11 * r29;
    ...
    r15 = r15 * r27;
    r15 = r15 * r1;
    WriteSum3<float, float>((float*)inout_shared, r0, r0, r15);
  };
  ...
  if (global_thread_idx < problem_size) {
    r1 = r1 * r1;
    WriteSum3<float, float>((float*)inout_shared, r0, r0, r1);
  };
...
void PinholeLogDepthFixedRotationFixedScaleFixedPointResJacFirst(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeLogDepthFixedRotationFixedScaleFixedPointResJacFirstKernel<<<n_blocks,
                                                                      1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
