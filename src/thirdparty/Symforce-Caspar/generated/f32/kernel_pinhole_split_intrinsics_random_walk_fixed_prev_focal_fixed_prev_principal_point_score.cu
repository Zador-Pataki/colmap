#include "kernel_pinhole_split_intrinsics_random_walk_fixed_prev_focal_fixed_prev_principal_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointScoreKernel(
        float* next_focal,
...
void PinholeSplitIntrinsicsRandomWalkFixedPrevFocalFixedPrevPrincipalPointScore(
    float* next_focal,
    unsigned int next_focal_num_alloc,
    SharedIndex* next_focal_indices,
    float* next_principal_point,
