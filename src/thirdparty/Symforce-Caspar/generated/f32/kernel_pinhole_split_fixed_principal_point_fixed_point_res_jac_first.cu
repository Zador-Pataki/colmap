...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = r29 + r16;
    r58 = r58 + r16;
    r58 = fmaf(r11, r58, r13 * r24);
    r17 = fmaf(r58, r31, r17 * r40);
    r64 = r35 + r64;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = r42 * r56;
    r42 = r6 <= r33 ? r45 : r42;
    r46 = fmaf(r39, r42, r46);
    r45 = r1 * r9;
    r45 = r45 * r57;
    r46 = fmaf(r10, r45, r46);
    r42 = fmaf(r7, r42, r5);
    r5 = r3 * r9;
    r5 = r5 * r57;
    r42 = fmaf(r10, r5, r42);
  ...
  FlushSumShared<2, float>(out_focal_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r46 = fmaf(r41, r46, r12 * r42);
    WriteSum1<float, float>((float*)inout_shared, r46);
  };
