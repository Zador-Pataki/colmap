#include "kernel_pinhole_split_fixed_rotation_fixed_principal_point_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedPrincipalPointFixedPointScoreKernel(
        float* rotation,
...
void PinholeSplitFixedRotationFixedPrincipalPointFixedPointScore(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeSplitFixedRotationFixedPrincipalPointFixedPointScoreKernel<<<n_blocks,
                                                                      1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
