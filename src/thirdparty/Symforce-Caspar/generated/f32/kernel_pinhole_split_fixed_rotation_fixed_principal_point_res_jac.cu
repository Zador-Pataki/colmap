#include "kernel_pinhole_split_fixed_rotation_fixed_principal_point_res_jac.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedPrincipalPointResJacKernel(
        float* rotation,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r57 = r26 < r37 ? r41 : r57;
    r36 = r37 * r57;
    r36 = fmaf(r45, r36, r41 * r44);
    r36 = r37 * r36;
    r36 = r36 * r46;
    r36 = r6 <= r31 ? r5 : r36;
    r41 = fmaf(r13, r36, r54);
    r61 = r0 * r4;
    r61 = r61 * r47;
...
void PinholeSplitFixedRotationFixedPrincipalPointResJac(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeSplitFixedRotationFixedPrincipalPointResJacKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
