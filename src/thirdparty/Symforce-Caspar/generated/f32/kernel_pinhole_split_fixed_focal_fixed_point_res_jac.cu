...
__global__ void __launch_bounds__(1024, 1)
  ...
  FlushSumShared<2, float>(out_principal_point_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r57 = fmaf(r12, r57, r41 * r53);
    WriteSum1<float, float>((float*)inout_shared, r57);
  };
