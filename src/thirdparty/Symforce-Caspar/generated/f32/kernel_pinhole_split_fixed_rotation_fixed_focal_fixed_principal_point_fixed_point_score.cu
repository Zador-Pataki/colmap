#include "kernel_pinhole_split_fixed_rotation_fixed_focal_fixed_principal_point_fixed_point_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedRotationFixedFocalFixedPrincipalPointFixedPointScoreKernel(
        float* rotation,
...
void PinholeSplitFixedRotationFixedFocalFixedPrincipalPointFixedPointScore(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
