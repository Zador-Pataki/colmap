#include "kernel_pinhole_log_depth_fixed_rotation_fixed_scale_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationFixedScaleJtjnjtrDirectKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx3<1024, float, float, float4>(
        point_jac, 0 * point_jac_num_alloc, global_thread_idx, r5, r6, r7);
    r3 = fmaf(r3, r6, r4 * r7);
    r3 = fmaf(r2, r5, r3);
    r3 = r1 * r3;
    WriteSum3<float, float>((float*)inout_shared, r0, r0, r3);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r6 = r6 * r1;
    r1 = r7 * r1;
    WriteSum3<float, float>((float*)inout_shared, r5, r6, r1);
  };
...
void PinholeLogDepthFixedRotationFixedScaleJtjnjtrDirect(
    float* translation_njtr,
    unsigned int translation_njtr_num_alloc,
    SharedIndex* translation_njtr_indices,
    float* translation_jac,
  ...
  PinholeLogDepthFixedRotationFixedScaleJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      translation_njtr,
