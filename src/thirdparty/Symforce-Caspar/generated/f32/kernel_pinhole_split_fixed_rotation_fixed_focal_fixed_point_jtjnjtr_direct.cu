...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, float, float, float2>(translation_jac,
                                         ...
                                         r12,
                                         r13);
    r5 = fmaf(r12, r5, r13 * r10);
    WriteSum3<float, float>((float*)inout_shared, r4, r11, r5);
  };
  ...
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r2 = fmaf(r11, r2, r5 * r0);
    r2 = fmaf(r4, r12, r2);
    r3 = fmaf(r11, r3, r5 * r1);
    r3 = fmaf(r4, r13, r3);
    r7 = fmaf(r7, r3, r6 * r2);
    r2 = fmaf(r8, r2, r9 * r3);
    WriteSum2<float, float>((float*)inout_shared, r7, r2);
  };
