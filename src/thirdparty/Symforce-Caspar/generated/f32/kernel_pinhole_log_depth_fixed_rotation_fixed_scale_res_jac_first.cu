#include "kernel_pinhole_log_depth_fixed_rotation_fixed_scale_res_jac_first.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationFixedScaleResJacFirstKernel(
        float* rotation,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = r3 < r26 ? r28 : r31;
    r31 = r3 < r22 ? r35 : r31;
    r31 = fmaf(r13, r21, r31 * r17);
    r31 = r22 * r31;
    r31 = r31 * r29;
    r31 = r19 <= r1 ? r0 : r31;
    r13 = fmaf(r30, r13, r14 * r31);
    r13 = r13 + r20;
    r6 = r6 * r2;
    r6 = r0 < r4 ? r6 : r0;
    r31 = r6 * r32;
...
void PinholeLogDepthFixedRotationFixedScaleResJacFirst(
    float* rotation,
    unsigned int rotation_num_alloc,
    float* translation,
    unsigned int translation_num_alloc,
  ...
  PinholeLogDepthFixedRotationFixedScaleResJacFirstKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
