...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx4<1024, float, float, float4>(
        pose_jac, 4 * pose_jac_num_alloc, global_thread_idx, r4, r7, r28, r29);
    r30 = fmaf(r7, r17, r4 * r27);
    r31 = fmaf(r29, r17, r28 * r27);
    WriteSum4<float, float>((float*)inout_shared, r19, r5, r30, r31);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx4<1024, float, float, float4>(
        pose_jac, 8 * pose_jac_num_alloc, global_thread_idx, r31, r30, r5, r19);
    r32 = fmaf(r30, r17, r31 * r27);
    r27 = fmaf(r5, r27, r19 * r17);
    WriteSum2<float, float>((float*)inout_shared, r32, r27);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = fmaf(r17, r2, r31);
    r26 = r31 + r26;
    r29 = fmaf(r34, r29, r32 * r19);
    r29 = fmaf(r33, r7, r29);
    r29 = fmaf(r5, r1, r29);
    r29 = fmaf(r17, r3, r29);
    r29 = fmaf(r27, r30, r29);
    r18 = r29 + r18;
  ...
  if (global_thread_idx < problem_size) {
    r6 = r29 + r6;
    r12 = r31 + r12;
    r22 = fmaf(r22, r12, r23 * r6);
    r24 = fmaf(r24, r12, r25 * r6);
    r12 = fmaf(r20, r12, r21 * r6);
    WriteSum3<float, float>((float*)inout_shared, r22, r24, r12);
  };
