#include "kernel_pinhole_log_depth_fixed_pose_fixed_scale_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedPoseFixedScaleScoreKernel(
        float* point,
...
void PinholeLogDepthFixedPoseFixedScaleScore(float* point,
  ...
  PinholeLogDepthFixedPoseFixedScaleScoreKernel<<<n_blocks, 1024>>>(
      point,
      point_num_alloc,
      point_indices,
      log_depth,
