#include "kernel_pinhole_log_depth_fixed_rotation_score.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeLogDepthFixedRotationScoreKernel(float* rotation,
...
void PinholeLogDepthFixedRotationScore(float* rotation,
                                       unsigned int rotation_num_alloc,
                                       float* translation,
                                       unsigned int translation_num_alloc,
                                       SharedIndex* translation_indices,
  ...
  PinholeLogDepthFixedRotationScoreKernel<<<n_blocks, 1024>>>(
      rotation,
      rotation_num_alloc,
      translation,
