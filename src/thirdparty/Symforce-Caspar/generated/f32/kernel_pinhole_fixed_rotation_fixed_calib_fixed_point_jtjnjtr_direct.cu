#include "kernel_pinhole_fixed_rotation_fixed_calib_fixed_point_jtjnjtr_direct.h"
#include "memops.cuh"
...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedRotationFixedCalibFixedPointJtjnjtrDirectKernel(
...
void PinholeFixedRotationFixedCalibFixedPointJtjnjtrDirect(
    float* translation_njtr,
    unsigned int translation_njtr_num_alloc,
    SharedIndex* translation_njtr_indices,
    float* translation_jac,
  ...
  PinholeFixedRotationFixedCalibFixedPointJtjnjtrDirectKernel<<<n_blocks,
                                                                1024>>>(
      translation_njtr,
